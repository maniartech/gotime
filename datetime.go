...
func (d DateTime) Monday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+1))
...
func (d DateTime) Tuesday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+2))
...
func (d DateTime) Wednesday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+3))
...
func (d DateTime) Thursday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+4))
...
func (d DateTime) Friday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+5))
...
func (d DateTime) Saturday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+6))
...
func (d DateTime) Sunday(weeks ...int) DateTime {
	...
	d = Date(DayStart().AddDate(0, 0, -int(DayStart().Weekday())+w*7+7))
