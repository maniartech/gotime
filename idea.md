...
// Time Ago
temporal.Parse("2019-01-01", "yyyy-mm-dd").Format("dd-mm-yyyy")
temporal.Parse("2019-01-01", "yyyy-mm-dd").Monday()
temporal.Parse("2019-01-01", "yyyy-mm-dd").Monday().TimeAgo() // Time ago from now
temporal.Parse("2019-01-01", "yyyy-mm-dd").Monday().TimeAgo(temporal.Yesterday()) // Time ago from yesterday
