...
func TestParse(t *testing.T) {
	...
	format, _ := ids.Parse("dd-mm-yyyy", "24-01-1984")
...
func TestParseWithLocation(t *testing.T) {
	// Test case for parsing the date 24-01-1984
	format, _ := ids.ParseInLocation("dd-mm-yyyy", "24-01-1984", time.FixedZone("IST", 5.5*60*60))
...
func BenchmarkParse(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		ids.Parse("24-01-1984", "dd-mm-yyyy")
	}
}
